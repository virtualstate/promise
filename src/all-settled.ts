...
export function allSettled<T, TArgs extends  PromiseArgTuple<T>>(this: unknown, ...promises: TArgs): TheAsyncThing<PromiseSettledTupleIntermediate<TArgs>, PromiseSettledTuple<TArgs>>
...
export function allSettledGenerator<T, TArgs extends  PromiseArgTuple<T>>(this: unknown, ...promises: TArgs): AsyncIterable<PromiseSettledTupleIntermediate<TArgs>>
